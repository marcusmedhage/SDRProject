...
class Eigenvalue_detector_USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Number_of_channels = Number_of_channels = 4

        ##################################################
        # Blocks
        ##################################################

        self._Number_of_channels_range = Range(1, 20, 1, 4, 200)
        ...
        self._Threshold_range = Range(0.5, 4, 0.1, 0.5, 200)
        ...
        self.epy_block_1_0 = epy_block_1_0.blk(vectorSize=16384, Pfa=0.05, Threshold=Threshold, sampling_rate=samp_rate, num_channels=Number_of_channels, channel=channel_selector)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.epy_block_1_0, 'messageOutput'), (self.blocks_message_debug_0_0, 'log'))
